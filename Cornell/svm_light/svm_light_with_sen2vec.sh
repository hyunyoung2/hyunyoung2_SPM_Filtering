...
./svm_classify  ../../data/SVM_Light/test/SKIP_GRAM_SVM_Light_test ./SKIP_GRAM_SVM_Light_train_model ./SKIP_GRAM_SVM_Lihgt_Prediction > ./log/SKIP_GRAM_SVM_Light_test_result

echo "starting classifciation senetences based on CBOW"
echo "check the result on CBOW_SVM_Light_test_result"

./svm_classify  ../../data/SVM_Light/test/CBOW_SVM_Light_test  ./CBOW_SVM_Light_train_model ./CBOW_SVM_Light_Predictioni > ./log/CBOW_SVM_Light_test_result
